        ...
        <div class="row">
            <div class="col-lg-12 mb-3 order-0">
                <div class="card mb-4">
                    <!-- Account -->
                    <div class="card-body">
                        <h1 class="h3 fw-bold text-dark mb-4">Profile</h1>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="email" name="email"
                                        value="{{ Auth::user()->email }}" placeholder="ur.email@example.com" required />
                                    @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <form id="formAccountSettings" method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="d-flex">
                                        <input class="form-control me-2" type="password" id="oldPassword"
                                            name="current_password" value="" autofocus />
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="d-flex">
                                        <input class="form-control me-2" type="password" id="newPassword" name="password"
                                            value="" />
                                        <span class="input-group-text cursor-pointer eyeBtn"><i
                                                class="bx bx-hide"></i></span>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <p>Ketika anda melakukan reset password maka password akan diset pada password default
                                        yaitu <strong>user</strong>. Mohon untuk segera melakukan perubahan password setelah
                                        melakukan reset
