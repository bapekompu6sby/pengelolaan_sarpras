...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            ...
            <!-- Kolom kanan: Aula, Kelas, Asrama, Paviliun -->
            <div class="col-lg-6">
                                ...
                                <div class="capacity">
                                    <div class="d-flex justify-content-evenly flex-wrap">
                                        <div class="left">
                                            ...
                                            <h4 class="card-title text-nowrap mb- text-danger text-center">
                                                {{ $aulaStock }}</h4>
                                        </div>
                                        <div class="right">
                                            <span class="d-block mb-1">Kosong</span>
                                            <h4 class="card-title text-nowrap mb-2 text-success text-center">
                                                {{ $availableAula }}</h4>
                                        </div>
                                        <div class="bottom">
                                            <span class="d-block mb-1">Terisi</span>
                                            <h4 class="card-title text-nowrap mb-2 text-warning text-center">
                                                {{ $aulaNotAvailable }}</h4>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12 col-md-6 mb-4">
                        <div class="card" id="paviliun-sum">
                            <div class="card-body">
                                <div class="card-title">
                                    <h4 class="text-nowrap mb-2">
                                        <span class="badge" style="background-color:#6f42c1; color:white;" me-2>
                                            <i class="bx bx-buildings"></i>
                                        </span>
                                        Paviliun
                                    </h4>
                                            ...
                                            <div class="col p-5" style="margin-left: 10px; margin-right: 10px;">
                                                <div class="card-body text-center mx-2">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <h6 class="text-dark mb-1">{{ $e->properties->name }}
                                                        </h6>
                                                    </div>
